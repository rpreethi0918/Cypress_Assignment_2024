...
export class RobotHands extends BaseHands {
  ...
  clickProfile(selector: string) {
    this.clickOnDomElement(selector);
    return this;
  }

  selectLogoutFromDropDown(selector: string, text:string){
...
export class RobotEyes extends BaseEyes {
  ...
  verifyUsernameField() {
    this.findTextInputBox(SELECTORS.USERNAME_FIELD, STATIC_VALUES.USERNAME_PLACEHOLDER);
    return this;
  }

  verifyPasswordField() {
    this.findTextInputBox(SELECTORS.PASSWORD_FIELD, SELECTORS.PASSWORD_PLACEHOLDER);
    return this;
  }

  verifyLoginButton() {
    this.seesDomContainText(SELECTORS.LOGIN_BUTTON, SELECTORS.LOGIN_BUTTON_TEXT);
    return this;
  }
